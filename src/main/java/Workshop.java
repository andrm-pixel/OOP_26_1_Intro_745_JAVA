...
public class Workshop {
    ...
    public int[] eliminarDuplicados(int[] arreglo) {
        ...
        for (int i = 0; i < count; i++) finalArr[i] = temp[i];
        return finalArr;
    }
    ...
    public int[] combinarArreglos(int[] arreglo1, int[] arreglo2) {
        ...
        for (int i = 0; i < arreglo1.length; i++) res[i] = arreglo1[i];
        for (int i = 0; i < arreglo2.length; i++) res[arreglo1.length + i] = arreglo2[i];
        return res;
    }
    ...
    public String reemplazarSubcadena(String cadena, String antiguaSubcadena, String nuevaSubcadena) {
        ...
        int idx = cadena.indexOf(antiguaSubcadena);
        if (idx == -1) return cadena;
        return cadena.substring(0, idx) + nuevaSubcadena + cadena.substring(idx + antiguaSubcadena.length());
    }
    ...
    public String jugarPiedraPapelTijeraLagartoSpock(String eleccionUsuario) {
        ...
        String cpu = "Piedra";
        if (eleccionUsuario.equals(cpu)) return "Empate";
        if ((eleccionUsuario.equals("Piedra") && (cpu.equals("Tijera") || cpu.equals("Lagarto"))) ||(eleccionUsuario.equals("Papel") && (cpu.equals("Piedra") || cpu.equals("Spock")))) {
            return "Ganaste";
        }
        return "Perdiste";
    }
...
Rock crushes Scissors
	...
	double A = double(Math.PI * (radio * radio));
        return A;
    }
